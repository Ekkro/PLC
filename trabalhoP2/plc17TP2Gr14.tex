...
%O que se lhe pede neste trabalho é que, depois de investigar os tais pré-processadores a linguagem de um Wiki, %especifique uma sua linguagem de anotação para abreviar a escrita de formatação (negrito, itálico, sublinhado, %váriosnı́veis de tı́tulos) e listas de tópicos (items) não-numerados, numerados ou tipo entradas de um dicionário. %Deve a seguir criar, com a ferramenta Flex, um processador que transforme a sua notação em HTML.
%

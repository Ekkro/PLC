...
\begin{abstract}
Este trabalho foca-se os conceitos básicos do funcionamento GAWK e das expressões
regulares utilizadas para descrever padrões.
Neste relatório descrevemos as decisões tomadas e as dificuldades encontradas bem
como pequenos exemplos, para que qualquer um que o leia perceba facilmente como
funciona o nosso projeto.
\end{abstract}

\tableofcontents

\chapter{Introdução} \label{intro}
Uma parte importante do sistema linux são as expressões regulares, a capacidade
de procurar num input um determinado padrão facilita muitas das operações.
